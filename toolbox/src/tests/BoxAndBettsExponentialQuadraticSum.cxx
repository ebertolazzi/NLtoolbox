...
public:
  ...
  evalFk( dvec_t const & x_in, int_type k ) const override {
    ...
    switch ( k ) {
      case 0: return -t9*t2/5.0-2.0/5.0*t20*t13-3.0/5.0*t31*t24-4.0/5.0*t42*t35-t53*t46-6.0/5.0*t63*t56-7.0/5.0*t74*t67-8.0/5.0*t85*t78-9.0/5.0*t96*t89-2.0*t104*t99;
      case 1: return t9*t4/5.0+2.0/5.0*t20*t15+3.0/5.0*t31*t26+4.0/5.0*t42*t37+t53*t48+6.0/5.0*t63*t58+7.0/5.0*t74*t69+8.0/5.0*t85*t80+9.0/5.0*t96*t91+2.0*t104*t100;
      case 2: return  -2.0*t9*t7-2.0*t20*t18-2.0*t31*t29-2.0*t42*t40-2.0*t53*t51-2.0*t63*t61-2.0*t74*t72-2.0*t85*t83-2.0*t96*t94-2.0*t104*t102;
    }
    return 0;
  }
  ...
  evalF( dvec_t const & x_in, dvec_t & f ) const override {
    ...
    real_type t102 = t6-t101;
    real_type t104 = t99-t100-t102*z;
    f(0) = -t9*t2/5.0-2.0/5.0*t20*t13-3.0/5.0*t31*t24-4.0/5.0*t42*t35-t53*t46-6.0/5.0*t63*t56-7.0/5.0*t74*t67-8.0/5.0*t85*t78-9.0/5.0*t96*t89-2.0*t104*t99;
    f(1) = t9*t4/5.0+2.0/5.0*t20*t15+3.0/5.0*t31*t26+4.0/5.0*t42*t37+t53*t48+6.0/5.0*t63*t58+7.0/5.0*t74*t69+8.0/5.0*t85*t80+9.0/5.0*t96*t91+2.0*t104*t100;
    f(2) = -2.0*t9*t7-2.0*t20*t18-2.0*t31*t29-2.0*t42*t40-2.0*t53*t51-2.0*t63*t61-2.0*t74*t72-2.0*t85*t83-2.0*t96*t94-2.0*t104*t102;
  }
  ...
  jacobian( dvec_t const & x_in, dvec_t & jac ) const override {
    ...
    real_type t128 = t3/50.0+t11*t2/50.0+2.0/25.0*t16+2.0/25.0*t24*t15+9.0/50.0*t29
                      +9.0/50.0*t37*t28+8.0/25.0*t42+8.0/25.0*t50*t41+t55/2.0+t63*t54/2.0+18.0/25.0*t68
                      +18.0/25.0*t76*t67+49.0/50.0*t81+49.0/50.0*t89*t80+32.0/25.0*t94+32.0/25.0*t102*t93
                      +81.0/50.0*t107+81.0/50.0*t115*t106+2.0*t119+2.0*t125*t118;
    ...
    real_type t169 = t9*t2/5.0+2.0/5.0*t15*t22+3.0/5.0*t28*t35+4.0/5.0*t41*t48+t54*t61
                      +6.0/5.0*t74*t67+7.0/5.0*t80*t87+8.0/5.0*t93*t100+9.0/5.0*t106*t113+2.0*t118*t123;
    ...
    real_type t210 = t170/50.0-t11*t6/50.0+2.0/25.0*t174-2.0/25.0*t24*t19+9.0/50.0*t178
                      -9.0/50.0*t37*t32+8.0/25.0*t182-8.0/25.0*t50*t45+t186/2.0-t63*t58/2.0+18.0/25.0*t190
                      -18.0/25.0*t76*t71+49.0/50.0*t194-49.0/50.0*t89*t84+32.0/25.0*t198-32.0/25.0*t102*t97
                      +81.0/50.0*t202-81.0/50.0*t115*t110+2.0*t206-2.0*t125*t121;
    real_type t230 = -t6*t9/5.0-2.0/5.0*t19*t22-3.0/5.0*t32*t35-4.0/5.0*t45*t48-t58*t61
                      -6.0/5.0*t71*t74-7.0/5.0*t84*t87-8.0/5.0*t97*t100-9.0/5.0*t110*t113-2.0*t121*t123;
    ...
    Eigen::Map<dmat_t> JAC(jac.data(),n,n);
    JAC(0,0) = t128;
    JAC(0,1) = t149;
    JAC(0,2) = t169;
    JAC(1,0) = t149;
    ...
    JAC(2,0) = t169;
    JAC(2,1) = t230;
    JAC(2,2) = 2.0*t231+2.0*t232+2.0*t233+2.0*t234+2.0*t235+2.0*t236+2.0*t237+2.0*t238+2.0*t239+2.0*t240;
  }
  ...
  getExactSolution( dvec_t & x, int_type idx ) const override {
    ...
    case 1:
      ...
      x(1) =  1;
      x(2) = -1;
      // and where ever x(0)=x(1) and x(3)=0
      break;
    }
  }
